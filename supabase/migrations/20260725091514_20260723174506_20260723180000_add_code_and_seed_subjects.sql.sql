...
3. Data
   ...
   - Idempotent: ON CONFLICT on name (and name,major where that constraint exists) DO NOTHING.
...
-- Add UNIQUE(name, major) only if neither it nor UNIQUE(name) already exist,
