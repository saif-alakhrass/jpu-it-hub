...
import { canTransition, transitionFile, removeFromPending, updateInList } from './fileStatus';
import type { FileRow } from './types';

function makeFile(overrides: Partial<FileRow> = {}): FileRow {
  return {
    id: 'f1', subject_id: 's1', tab: 'summaries', title: 'ملخص الفصل الأول',
    storage_path: 'u1/file.pdf', file_url: 'https://example.com/file.pdf',
    file_type: 'pdf', file_size: 1024, uploader_id: 'u1', status: 'pending',
    created_at: '2025-01-01T00:00:00Z', batch_id: null,
    storage_provider: 'supabase', object_key: null, file_hash: null, mime_type: null,
    ...overrides,
  };
}
